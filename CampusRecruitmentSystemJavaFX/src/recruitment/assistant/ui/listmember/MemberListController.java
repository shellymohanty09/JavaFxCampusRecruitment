package recruitment.assistant.ui.listmember;
...
import recruitment.assistant.export.pdf.ListToPDF;
import recruitment.assistant.ui.addcompany.CompanyAddController;
import recruitment.assistant.ui.addmember.MemberAddController;
...
public class MemberListController implements Initializable {
    ...
    private void handleMemberDelete(ActionEvent event) {
        ...
        if (DatabaseHandler.getInstance().isMemberHasAnyCompanies(selectedForDeletion)) {
            AlertMaker.showErrorMessage("Cant be deleted", "This member has some companies.");
            return;
        }
        ...
        if (answer.get() == ButtonType.OK) {
            ...
            if (result) {
                AlertMaker.showSimpleAlert("Company deleted", selectedForDeletion.getName() + " was deleted successfully.");
    ...
    private void handleMemberEdit(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/recruitment/assistant/ui/addmember/member_add.fxml"));

package recruitment.assistant.alert;
...
public class AlertMaker {
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource(RecruitmentAssistantUtil.ICON_IMAGE_LOC));
            TrayIcon trayIcon = new TrayIcon(image, "Recruitment Assistant");
            trayIcon.setImageAutoSize(true);
            trayIcon.setToolTip("Recruitment Assistant");
            tray.add(trayIcon);
